 ...
 * 
 */
public class Adaptation_innovationNew {
	//tweet |akun, is_tweet|
	//tweet per akun
    ...
    //(akun) tweet per retweet (di retweet)
...
//        System.err.println("usage: hadoop -jar <...> Adaptation_innovationNew <input tweet> <output tweet> <input retweet> <output retweet> <output result>");
//	      //data-in/tweet/data.txt data-out/tweet 
//          //data-in/retweet/data_new.txt data-out/retweet
//          //data-out/result
//        System.exit(-1);
//    }
	public static void main(String[] args) throws Exception
	{
		...
		String IN_TWEET="./data-in/adaptation_innovation/tweet/data.txt"; //tweet path
		String OUT_TWEET="./data-out/adaptation_innovation/tweet"; //tweet out path
		...
		String IN_RETWEET = "./data-in/adaptation_innovation/retweet/data_new.txt";//retweet path
		String OUT_RETWEET = "./data-out/adaptation_innovation/retweet";// retweet output path
		...
		String OUT = "data-out/adaptation_innovation/result"; // result output path
