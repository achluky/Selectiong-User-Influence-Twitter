...
public class Friend_pow {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	if (fs.exists(new Path("data-out/frPw"))) {
        	fs.delete(new Path("data-out/frPw"), true);
		}
        ...
        FileInputFormat.addInputPath(job, new Path("data-in/frPw"));
        FileOutputFormat.setOutputPath(job, new Path("data-out/frPw"));
        /**
